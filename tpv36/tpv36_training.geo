...
date: 16th Dec. 2024
*/
DefineConstant[ h_domain = {10e3, Min 0, Max 500e3, Name "Mesh spacing in domain" } ];
...
DefineConstant[ dip = {15.0, Min 0, Max 90, Name "Fault dip" } ];
DefineConstant[h_surf = 1000.0];
...
MeshSize{ PointsOf{Surface{top[]};} } = h_surf;
